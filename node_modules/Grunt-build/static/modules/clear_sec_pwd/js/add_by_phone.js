...
define([
    ...
    var addByPhone = {
        ...
        init: function() {
            ...
            /*发送手机验证码初始化*/
            modulesUtil.sendPhoneCode( "register_phone", "safe_code_phone",  "clear_sec_pwd" , "sendPhoneCode" );
        },
        domainUrl: "http://kf.37.com",
        vercodeUrl: "/index.php?c=index&a=aucode",//统一验证码
        verphoneCodeUrl: "/index.php?c=clear_sec_pwd&a=sendPhoneCode",//发送手机验证码
        stepOneUrl: "/index.php?c=clear_sec_pwd&a=verifyPhoneCode",//第一步提交
        stepTwoUrl: "/index.php?c=clear_sec_pwd&a=actAddByPhone",//数据提交
        dataArr:{
            register_phone:"",//验证手机
            phone_code: "",//手机验证码
            game: "",//游戏
        ...
        getDom: function(){
            ...
            _this.$cspPhone = $(".csp-phone");
            _this.$serviceBar = _this.$cspPhone.find(".service-bar-1");
            _this.$serviceFromVercode = _this.$cspPhone.find(".service-form-vercode");
            _this.$formOne = _this.$cspPhone.find("#service-form-edit-one");
            _this.$formTwo = _this.$cspPhone.find("#service-form-edit-two");
            _this.$formResult = _this.$cspPhone.find("#service-form-result");
            _this.$formOther = _this.$cspPhone.find(".service-other");
            _this.$formResultVip = _this.$cspPhone.find("#service-form-result-vip");
        },
        /*绑定事件*/
        event: function(){
            var _this = this,
