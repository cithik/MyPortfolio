...
define([
    ...
    var reset = {
        ...
        stepTwoUrl: "/index.php?c=clear_sec_pwd&a=actAddByNormal",
        ...
        _this.$container                = $(".container");
            _this.$cspNormal            = $(".csp-normal");
            _this.$serviceBar           = _this.$cspNormal.find(".service-bar-1");
            _this.$serviceFromVercode   = _this.$cspNormal.find(".service-form-vercode");
            _this.$formOne              = _this.$cspNormal.find("#service-form-edit-one");
            _this.$formTwo              = _this.$cspNormal.find("#service-form-edit-two");
            _this.$formThree            = _this.$cspNormal.find("#service-form-edit-three");
            _this.$formFour             = _this.$cspNormal.find("#service-form-edit-four");
            _this.$formResult           = _this.$cspNormal.find("#service-form-result");
            _this.$formOther            = _this.$cspNormal.find(".service-other");
            _this.$formResultVip        = _this.$cspNormal.find("#service-form-result-vip");
        },
        /*渲染select表单*/
        selectInit: function(){
